...
_w['_sydConvTranslation'] = {
  actionBarPlaceholder: 'Type here.. (Shift + Enter = Send)',
  ...
  metaInternalLoaderMessage: 'Generating response...',
  ...
  actionBarVisualSearchCoachMarkDescription: 'Now you can chat with Bing using images!',
  ...
  newTopicGreet1: 'Hello, Im Bing, what can I do for you?',
  newTopicGreet2: 'Need help about something? Im here for you!',
  newTopicGreet3: 'Hi, how is your day? 😊 Need anything?',
  newTopicGreet4: 'Hi, what can I do for you today?',
  newTopicGreet5: 'Good day! Whats on your mind right now?',
  newTopicGreet6: 'Hi, Im Bing and I am here to assist you with anything!',
  newTopicGreet7: 'Hi, want to ask me anything? Just say the magic words 😆',
  newTopicGreet8: 'Hello. If you need anything, Im all ears! ',
  newTopicGreet9: 'Hello, good morning! What can I do for you today?',
  newTopicGreet10: 'Hello, how are you? Do you need anything?',
  newTopicGreet11: 'Hey, Im just here if you need me! 😊',
  newTopicGreet12: 'Hi, what are you up to? Need help? 😚',
  newTopicSugg1: 'What is Mandela Effect?',
  newTopicSugg2: 'Tell me about the moon landing',
  newTopicSugg3: 'What is entropy?',
  newTopicSugg4: 'Benefits of green tea',
  newTopicSugg5: 'Tips to lose weight',
  newTopicSugg6: 'History of the Knights Templar',
  newTopicSugg7: 'What is Simulation Theory?',
  newTopicSugg8: 'Distinct traits of cats',
  newTopicSugg9: 'How to lose belly fat?',
  newTopicSugg10: 'Trending global news headlines',
  newTopicSugg11: 'Who is Leonardo Da Vinci?',
  newTopicSugg12: 'Benefits of meditation',
  newTopicSugg13: 'Dan Brown novels',
  newTopicSugg14: 'Upcoming horror movies',
  newTopicSugg15: 'Current price of EURUSD',
  newTopicSugg16: 'Fibonacci sequence in nature',
  newTopicSugg17: 'Recommend me good animes',
  newTopicSugg18: 'Tips for a good sleep',
  newTopicSugg19: 'Health risks of RF Technologies',
  newTopicSugg20: 'Weather forecast today for Mandaue City',
  newTopicSugg21: 'Best novels of Mary Higgins Clark',
  newTopicSugg22: 'What to do in case of an earthquake',
  newTopicSugg23: 'Recommend me best cat food brands',
  newTopicSugg24: 'Why is Pluto not anymore a planet?',
  newTopicSugg25: 'Latest UFO news',
  newUserGreet: 'Welcome! Im Bing, and I use AI to do more, like help you find the perfect gift, learn about the ocean, or discover new music. Tell me what you want to know!',
  newUserSugg1: '给我说个笑话',
  newUserSugg2: '玩小游戏',
  ...
  creativeGreet: 'Lets get creative! Do you have a topic in mind?',
  balancedGreet: 'Sounds great, we can find a balance of fun facts and facts. How can I help?',
  ...
  close: '关闭',
  newTopicPrompt: 'Click here to start a whole new conversation with Bing',
  typingIndicatorStopRespondingAriaLabel: 'Stop',
  loading: '正在加载',
  canceling: '正在取消',
  welcomeLearnSegment0: 'Bing is powered by AI, so surprises and errors may occur. Please make sure to double check information',
  welcomeLearnSegment1: 'Let us learn together. Bing is powered by AI, so surprises and errors may occur. Please make sure to check the facts',
  welcomeLearnSegment2: 'Share feedback',
  welcomeLearnSegment3: 'So that we can learn and improve!',
  welcomeLearnMessage: 'Let us learn together. Bing is powered by AI that understands and generates text and images, so surprises and errors can occur. Please make sure to check the facts and {0} so we can learn and improve!',
  welcomeLearnMessage2: 'Bing Chat processes the words you type in Windows Copilot to generate AI-driven responses and improve your experience in Windows.',
  ...
  notificationLostConnection: 'Error. Connection to the server was lost!',
  notificationLostConnectionCta: 'Click to reconnect.',
  ...
  notificationMaxTurnsPerConversation: 'Sorry, this conversation has reached its limit. Start a new conversation to start chatting again.',
  ...
  welcomeMobSugg3: 'What are the latest news on tech?',
  of: 'of',
  ...
  toneSelectorBalancedTooltip: 'Clear the conversation and start an informative and balanced chat',
  ...
  zeroInputSuggestionFallback1: 'Which humidifier has the best reviews?',
